...
st.title("Summary labour force indicators, RLFS 2022")
st.write("*Made with  by IHIMBAZWE Aristude")


file_path = 'RLFS Tables_ Annual_2022.xlsx'
df = pd.read_excel(ile_path, sheet_name='table 1')
...
st.write(round(df[['Summary labour force indicators, RLFS 2022', 'total', 'male', 'female', 'urban', 'rulal', 'Participated in  subsistence agriculture','Not participated in subsistence agriculture']].describe().T, 2))

#grouping by 'Region' and finding mean values for the numerical columns
regionStats = df.groupby(['Region'])[['Summary labour force indicators, RLFS 2022', 'total', 'male', 'female', 'urban', 'rulal', 'Participated in  subsistence agriculture','Not participated in subsistence agriculture']].mean().reset_index()
...
heatMap = df[['Summary labour force indicators, RLFS 2022', 'total', 'male', 'female', 'urban', 'rulal', 'Participated in  subsistence agriculture','Not participated in subsistence agriculture']]
...
fig = px.scatter_matrix(df,
    dimensions=['Summary labour force indicators, RLFS 2022', 'total', 'male', 'female', 'urban', 'rulal', 'Participated in  subsistence agriculture','Not participated in subsistence agriculture'],
    color='Region')
...
unempDF = df[['Summary labour force indicators, RLFS 2022', 'total', 'male', 'female', 'urban', 'rulal', 'Participated in  subsistence agriculture','Not participated in subsistence agriculture']]
